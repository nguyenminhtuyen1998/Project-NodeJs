...
async function main() {
  await mongoose.connect('mongodb+srv://nguyenminhtuyenkt98:19981998T@dbnodejs.oqvydox.mongodb.net/dataTranningNodej');
...
// const modelList = mongoose.model('Tuyen', list);
//    const people = await modelList.find({});
